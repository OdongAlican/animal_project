...
const Home = () => {
    ...
    return(
        <div className="home-section">
            ...
            <div className="lower-home-section">
                <div className="left-home-section">
                    ...
                    <div className="description-sectio p-2 bg-info">
                        <p>
                    ...
                    <div className="join-us-button">
                        ...
                        <div className="lower-description-section p-2 bg-warning">
                            <h6>
                ...
                <div className="right-home-section pt-0">
                    ...
                    <div className="abroad-section bg-secondary bg-warning p-2">
                    ...
                    <div className="news-section bg-secondary bg-danger p-2">
                        ...
                        <div className="date-input-section d-flex mt-2">
                            ...
                            <button className="ml-2">News</button>
                        </div>
                        <h6 className="mt-3">
                    ...
                    <div className="email-address bg-warning py-2">
                        ...
                        <button className="d-block m-auto border-0 p-2">Subscribe</button>
                    </div>
                </div>
            </div>
            <Footer/>
